...
- Зафиксируйте вывод `SELECT` в сеансе B: баланс остаётся 100 до `COMMIT`/`ROLLBACK` в A.
- В отчёте: «грязное чтение в PostgreSQL не воспроизводится» + скриншоты двух окон `psql`.
